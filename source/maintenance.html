...
<body class="page-template-default page page-id-2013 gdlr-core-body woocommerce-no-js attorna-body attorna-body-front attorna-full  attorna-with-sticky-navigation  attorna-blockquote-style-1 gdlr-core-link-to-lightbox" data-home-url=https://demo.goodlayers.com/attorna/>
            ...
            <div class=gdlr-core-page-builder-body>
                <div class="gdlr-core-pbf-wrapper  gdlr-core-wrapper-full-height gdlr-core-js gdlr-core-full-height-center" style="padding: 0px 0px 0px 0px;" data-skin="White Text">
                    <div class=gdlr-core-pbf-background-wrap>
                        <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(upload/layer-bg1.jpg) ;background-size: cover ;background-position: center ;" data-parallax-speed=0></div>
                    </div>
                                        ...
                                        <div class=gdlr-core-pbf-element>
                                            <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr" style="padding-bottom: 50px ;">
                                                <div class="gdlr-core-title-item-title-wrap ">
                                                    <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 54px ;letter-spacing: 0px ;text-transform: none ;">Maintenance Mode<span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider" ></span></h3></div><span class="gdlr-core-title-item-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-size: 21px ;font-style: normal ;">Our website is going under maintenance. We will be back very soon!.</span></div>
                                        </div>
                                        <div class=gdlr-core-pbf-element>
                                        ...
                                        <div class=gdlr-core-pbf-element>
                                            <div class="gdlr-core-skill-bar-item gdlr-core-item-pdlr gdlr-core-item-pdb  gdlr-core-size-large gdlr-core-type-round" style="padding-bottom: 0px ;">
                                                <div class=gdlr-core-skill-bar>
                                                    <div class="gdlr-core-skill-bar-head gdlr-core-title-font" style="width: 85% ;"><span class=gdlr-core-skill-bar-title style="color: #ffffff ;">Current  Process</span><span class=gdlr-core-skill-bar-right style="color: #ffffff ;">85%</span></div>
                                                    <div class=gdlr-core-skill-bar-progress style="background-color: #565656 ;">
                                                        <div class="gdlr-core-skill-bar-filled gdlr-core-js" data-width=85 style="background-color: #a69279 ;"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
